...
/** Implementation of Invalid policy interface that add passed rule */

public class InvalidPasswordPolicyImpl implements PasswordPolicy {

    private final List<Implementation> rules = new ArrayList<>();

    public InvalidPasswordPolicyImpl(final Implementation rule) {
        rules.add(rule);
    }
